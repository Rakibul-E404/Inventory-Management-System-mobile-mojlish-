...
//               // Use ValueListenableBuilder to listen to changes in selectedDateNotifier
...
//                   );
//                   // Update the selected date in the ValueNotifier
...
//                                       child: Center(
//                                         child: Text(
//                                           (provider.filteredSoldItems.indexOf(item) + 1).toString(),
//                                         ),
//                                       ),
//                                     ),
//                                   ),
...
//                                               (double.parse(item.payment) + provider.getTotalPayments(item.barcode)))
//                                               .toStringAsFixed(2),
//                                         ),
//                                       ),
//                                     ),
...
///
///
/// ---------checking it status is paid then delete it
///
