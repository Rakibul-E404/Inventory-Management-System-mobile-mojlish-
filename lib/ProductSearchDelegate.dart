...
//   final List<ProductModel> stockItems;
//
//   ProductSearchDelegate(this.stockItems);
//
//   @override
...
//     final results = stockItems.where((item) => item.name.toLowerCase().contains(query.toLowerCase())).toList();
//
...
//               context,
//               MaterialPageRoute(
//                 builder: (context) => ProductDetailsScreen(product: item, role: 'user'),
//               ),
//             );
//           },
//         );
...
//     final suggestions = stockItems.where((item) => item.name.toLowerCase().contains(query.toLowerCase())).toList();
//
//     return ListView.builder(
...
//           product.barcode == query;  // Match the barcode exactly
//     }).toList();
//
//     return ListView.builder(
//       itemCount: results.length,
...
//             // You can navigate to product details screen or do something with the selected product
//           },
//         );
//       },
//     );
