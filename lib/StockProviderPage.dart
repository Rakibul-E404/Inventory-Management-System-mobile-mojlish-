...
///
///
/// -----updating to set the cash screen
///
///
...
//     DateTime now = DateTime.now();
//     _filteredSoldItems.clear();
//     _filteredSoldItems.addAll(_soldItems.where((item) => isSameDay(DateFormat('yyyy-MM-dd – hh:mm').parse(item.dateTime), now)));
//     notifyListeners();
//   }
//
//   void filterLast7Days() {
...
//
//   void addExpense(String description, String amount, String date) {
//     _expenses.add({
...
//   }
//
//   void updateExpense(int index, String description, String amount, String date) {
//     if (index >= 0 && index < _expenses.length) {
//       _expenses[index] = {
//         'description': description,
//         'amount': amount,
...
//
//   void calculateTodayPayments(List<ProductModel> soldItems) {
//     DateTime today = DateTime.now();
//     double total = 0.0;
//
...
//         double additionalPayments = _getTotalPayments(item.barcode);
//         total += payment + additionalPayments;
//       }
//     }
//     _totalTodayPayments = total;
//     notifyListeners();
//   }
//
//   void calculateTodayExpense() {
//     DateTime now = DateTime.now();
//     double total = 0.0;
//
...
//   }
//
//   double _getTotalPayments(String barcode) {
//     // Implement the logic to get total payments for a specific barcode.
//     return 0.0; // Placeholder, update this with your logic.
//   }
//
